                  ...
                  <div className='d-flex features feature-clean core-feature rounded shadow p-4'>
                    ...
                    <div className='flex-1 ms-4'>
                      ...
                      <p className='text-muted mt-2 mb-0'>
                        People can all attest to the reputation of each other while attestation explorers can provide
                        reputation scores.
                      </p>
                    </div>
                  </div>
                ...
                <Col md={6} className='mt-4 mt-sm-0 pt-2 pt-sm-0'>
                  <div className='d-flex features feature-clean core-feature rounded shadow p-4'>
                    ...
                    <div className='flex-1 ms-4'>
                      ...
                      <p className='text-muted mt-2 mb-0'>
                        Now you can take your trust with you! Just sign into any web3 app and your trusted ratings
                        follow you!
                      </p>
                    </div>
                  </div>
                ...
                <Col md={6} className='mt-4 pt-2'>
                  <div className='d-flex features feature-clean core-feature rounded shadow p-4'>
                    ...
                    <div className='flex-1 ms-4'>
                      ...
                      <p className='text-muted mt-2 mb-0'>
                        User can make vote for a party member or proposal using an attestation type for voting.
                      </p>
                    </div>
                  </div>
                </Col>
                ...
                <Col md={6} className='mt-4 pt-2'>
                  <div className='d-flex features feature-clean core-feature rounded shadow p-4'>
                    ...
                    <div className='flex-1 ms-4'>
                      ...
                      <p className='text-muted mt-2 mb-0'>
                        KYC providers can attest that an ETH address has passed various thresholds of identity and
                        background checks.
                      </p>
                    </div>
                  </div>
